...
class Day06Test : public ::testing::Test {
 protected:
  Day06Solution solution;
};

// Tests for Part 1
TEST_F(Day06Test, Part1_Example) {
  // TODO: Update expected value based on the actual problem
  EXPECT_EQ(solution.part1(TEST_INPUT), "expected_result");
}

TEST_F(Day06Test, Part1_ActualInput) {
  auto input = aoc::Solution::readDayInput(6);
...
// Tests for Part 2
TEST_F(Day06Test, Part2_Example) {
  // TODO: Update expected value based on the actual problem
  EXPECT_EQ(solution.part2(TEST_INPUT), "expected_result");
}

TEST_F(Day06Test, Part2_ActualInput) {
  auto input = aoc::Solution::readDayInput(6);
