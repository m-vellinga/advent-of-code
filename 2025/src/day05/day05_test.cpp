...
class Day05Test : public ::testing::Test {
 protected:
  Day05Solution solution;
};

// Tests for Part 1
TEST_F(Day05Test, Part1_Example) {
  // TODO: Update expected value based on the actual problem
  EXPECT_EQ(solution.part1(TEST_INPUT), "expected_result");
}

TEST_F(Day05Test, Part1_ActualInput) {
  auto input = aoc::Solution::readDayInput(5);
...
// Tests for Part 2
TEST_F(Day05Test, Part2_Example) {
  // TODO: Update expected value based on the actual problem
  EXPECT_EQ(solution.part2(TEST_INPUT), "test_runs");
}

TEST_F(Day05Test, Part2_ActualInput) {
  auto input = aoc::Solution::readDayInput(5);
